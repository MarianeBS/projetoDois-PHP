...
class Cadastro extends Banco {
    ...
    public function editar(){
        return $this->updateAgendamentos($this->getId(),$this->getEmail(),$this->getSenha(),$this->getEndereco(),$this->getBairro(),$this->getCep(),$this->getCidade(),$this->getEstado()); 
    }

    public function excluir($id){
        return $this->deletarClientes($id);
    }
}
?>